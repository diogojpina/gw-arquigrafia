...
(function($) {
	...
	$.fn.raty = function(settings) {
		...
		for (var i = 1; i <= options.number; i++) {
			...
			// Avoids a nonexistent index (undefined) and ensures that the hint will be applied, it means different from null. 
			// Otherwise applies the current number.
...
//		hintList:		['bad', 'poor', 'regular', 'good', 'gorgeous'],
		hintList:		['ruin', 'pobre', 'regular', 'bom', 'ótimo'],
		number:			5,
		path:			'img/',
		readOnly:		false,
		scoreName:		'score',
