...
<script type="text/javascript">
    ...
    function editPhoto() {
    	$.post("${pageContext.request.contextPath}/photo/" + ${photoMgr.id} + "/photo/" + ${photo.id}, function(data) {});
    }
</script>

<a class="${className}" style="text-decoration: none; padding:0px;" id="idEdit" href="${pageContext.request.contextPath}/photo/${photoMgr.id}/edit/${photo.id}" onclick="">Editar</a>
