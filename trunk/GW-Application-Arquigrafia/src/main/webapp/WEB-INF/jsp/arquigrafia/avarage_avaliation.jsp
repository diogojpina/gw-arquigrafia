...
<%@ taglib prefix="binomial"
	uri="http://www.groupwareworkbench.org.br/widgets/binomial"%>
<%@ taglib prefix="r"
		...
		<div id="content">
						...
						<div id="binomialsWrap">
							<div id="binomialsUser">
								<binomial:generalAverage entity="${photo}"
									manager="${binomialMgr}" name="userBin"
		 ...
		 --%>
				...
				<div id="text_Bottom">
					...
					<p>  Avalie esta imagem de acordo com seus aspectos, compare também sua avaliação com as do outros usuários.
					     Caso já tenha feito a avaliação clique em Avaliar para alterá-la.</p>
					<a
			...
			<div id="sidebar_avaliation">
				...
				<div id="single_view_block">
					...
					<div id="single_view_header">
						<h1>
							<a href="<c:url value="/photo/${photo.id}" />" id="name"> <c:out
									value="${photo.name}" /></a>
						</h1>
						<ul id="single_view_image_rating" class="right">
							...
							<li><small><counter:showCounter
										...
										wrapClass="counter_show" /> e <binomial:count
										binomialMgr="${binomialMgr}" entity="${photo}" /> </small></li>
						</ul>
					</div>
					<!--   FIM - NOME / STATUS DA FOTO   -->
					<!--   FOTO   -->
					<%--img src="img/photos/8806.jpg" class="single_view_image" width="600" height="410" alt="" title="" /--%>
					<p:show clazz="single_view_image" foto="${photo}"
						photoMgr="${photoMgr}" />
