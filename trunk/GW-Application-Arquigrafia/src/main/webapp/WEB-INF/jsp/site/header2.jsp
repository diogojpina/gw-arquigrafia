...
<div id="header">
    <div id="title">
        <a href="index.htm"><img src="${pageContext.request.contextPath}/images/head1_left_top.png" width="350" height="100" alt="Arquigrafia Brasil" /></a>
    </div>
    <div id="header_top_right">
        ...
        <div id="suggestions">
            <a href="#" class="white_link">Sugest&otilde;es e Cr&iacute;ticas</a><br />
            <a href="#" class="white_link">Reportar Problema</a>
        </div>
    ...
    <div id="top_links" class="blue_link">
        <a href="index2.htm">In&iacute;cio</a>&nbsp;|&nbsp;<a href="help.htm">Ajuda</a>&nbsp;|&nbsp;<a href="privacy.htm">Privacidade</a>
            ...
            <ul style="list-style: none">
                ...
                <li style="display: inline">
                    <div id="search_options1">
                        <span class="option_on">Texto</span><span class="fat_separator">|</span><span class="option_off">Tags</span>
                        <br />
                        <span id="advancedSearch"><a href="#" class="orange_link">Busca Avan&ccedil;ada &gt;&gt;</a></span>
                    </div>
