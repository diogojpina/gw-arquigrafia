    ...
    <div id="footer_bottom" style="clear:both">
          <div id="footer_bottom_text">
            ...
            <div style="float: left; width: 12%; margin-top: 20px;">
             ...
             <div style="float: left; width: 17%; margin-top: 20px;">
            ...
            <div style="float: left; width: 11%; margin-top: 20px;">
                 Sob a licença de: <br/>
                 <a href="http://creativecommons.org/licenses/" target="_blanck"><img src="${pageContext.request.contextPath}/images/creativecommons_by.png" alt="Creative Commons"/></a>
            </div>
        </div>
    </div>
</div>