    		...
    		<div id="lb_fields">
    			<div id="lb_fields_1">
	    			<ul>
	    				...
	    				<li><input name="user.login" type="text" class="box" id="login" size="15" maxlength="30" /></li>
	    			</ul>
    			</div>
    			<div id="lb_fields_3">
    			...
    			<div id="lb_fields_2">
    				<ul>
    					...
    					<li><input name="user.password" type="password" class="box" id="senha" size="15" maxlength="30" /></li>
    				</ul>
    			</div>
    		</div>
    		<div id="lb_messages">
