...
<html>
    ...
    <body>
        ...
        <Widgets:ConteudoPagina titulo="Usuário">
            <br/>
            <ul>
            ...
            <center>
                <form id="form1" class="cmxform" name="dados" method="POST" action="<c:url value="/groupware-workbench/${param.collablet}/userMgr/${param.userMgr}" />" accept-charset="UTF-8">
                    <input type="hidden" name="user.id" value="<c:out value="${user.id}" />" />
                    <input type="hidden" name="user.idInstance" value="${param.collablet}" />
                    <div class="form_1" id="user_retrieve_form">
                		...
                		<ul class="field_line_f1">
                			<li class="label_f1"><span>Email:</span></li>
					...
					<div class="subsection_f1">
						<fieldset>
	                    	<c:if test="${roleMgr != null}">
	                        	<legend><span class="subtitle_f1">Atribuir papéis:</span></legend>
