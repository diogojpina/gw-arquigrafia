...
<r:callMethod methodName="getDirImagesRelativo" instance="${photoInstance}" var="dirImagen" />
...
<div>	
	<!--a rel="linkimage" href="${pageContext.request.contextPath}/${dirImagen}/${foto.nomeArquivo}">												
			<img alt="${foto.nome}" src="${pageContext.request.contextPath}/${dirImagen}/${showPrefix}${foto.nomeArquivo}">
	</a-->	
	<img alt="${foto.nome}" src="${pageContext.request.contextPath}/${dirImagen}/${showPrefix}${foto.nomeArquivo}">
</div>