...
<div id="header">
    <div id="title">
        <a href="${pageContext.request.contextPath}/groupware-workbench/photo/${photoMgr.id}/index">
    ...
    <div id="top_links" class="blue_link">
        <a href="${pageContext.request.contextPath}/groupware-workbench/photo/${photoMgr.id}/index">In&iacute;cio</a>
        &nbsp;|&nbsp;
        ...
        <div id="search_input">
            <ul style="list-style: none">
                <li style="display: inline">
                    <photo:simpleSearch photoInstance="${photoMgr}" />
                </li>
                <li style="display: inline">
    ...
    <div id="advancedSearchField" class="mid_blue_text">
        <div>
            <photo:advancedSearch photoInstance="${photoMgr}" formClass="form1" formLineClass="field_line_f1" formLabelClass="label_f1" formInputClass="input_f1"
